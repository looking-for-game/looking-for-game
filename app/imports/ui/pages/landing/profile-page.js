...
Template.Landing_Page.onCreated(function onCreated() {
  ...
  this.context = Players.getSchema().namedContext('Landing_Page');
});
...
Template.Landing_Page.events({
  'submit .profile-data-form'(event, instance) {
    ...
    const updatedProfileData = { firstName, lastName, title, picture, github,
      facebook, instagram, bio, interests, games, username };
